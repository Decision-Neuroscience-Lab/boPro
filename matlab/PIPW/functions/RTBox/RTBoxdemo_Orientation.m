...
% o'clock, press a green button; if to 1 o'clock, press a red button. 
...
record=nan(ntrials,5); % four columns: iTrial tiltRight respCorrect RT startSecs
...
% We make two green buttons equivalent and the same to two red buttons.
oldButtons=RTBox('ButtonNames',{'left' 'left' 'right' 'right'});

try % avoid dead screen, and show result, even incomplete
    [w, r]=Screen('OpenWindow',scrn,127);  % open a gray screen
    HideCursor;
    ...
    str=['This will test your RT to garbor orientation identification.\n\n' ...
    	...
    	'press a green button if it tilts to left,\n\n' ...
        'press a red button if it tilts to right'];
