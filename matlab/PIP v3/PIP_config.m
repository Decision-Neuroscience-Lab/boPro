...
%% Global parameters
params.dataDir = '/Users/dnl/Documents/MATLAB/PIP v3/data';
params.testing = 1;
params.startTrial = 1;
params.choicetime = 3;
params.drinktime = 4;
...
params.pleasantnessText = 'This question is about PLEASANTNESS.\n\nOn a scale of ''1'' to ''10'', where ''1'' indicates ''very unpleasant'', and ''10'' indicates ''very pleasant'', how pleasant are you finding the juice?\n\n\n\n\n\n[Use the left and right arrow to select a point, and the down arrow to make a selection]';
