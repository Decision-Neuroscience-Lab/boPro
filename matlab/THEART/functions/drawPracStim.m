function drawPracStim(params, totalReward, time, matured, pressed)
...
if matured == 1
    delay_text = sprintf('%.0f points', params.largeReward*100);
else
    delay_text = sprintf('%.0f point', params.smallReward*100);
end
