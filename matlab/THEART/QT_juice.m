function [trialLog] = QT_juice(params)
try
        ...
        while GetSecs <= blockStartTime + params.blockTime
            ...
            if keyIsDown && isnan(rt) % Key press
                ...
                while GetSecs < trialStartTime + rt + (params.iti/2) && GetSecs <= blockStartTime + params.blockTime
                    ...
                    DrawFormattedText(params.window, 'Juice is dispensing...', 'center', params.height.*(5/8),  [0 0 0], 40, 0, 0, 2);
                    if params.testing ~= 1
                        pumpInf(params.pump, params.juiceVolume);
                        
                        % Trigger QT drink trigger
                        io32(params.ioObj,params.address,33);
                        WaitSecs(0.01);
                        io32(params.ioObj,params.address,0);
